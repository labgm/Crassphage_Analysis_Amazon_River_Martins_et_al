...
setwd('/home/davidmartins/Documentos/Viral_analysis/contig_mapping/')
```
...
data <- read.csv('itac_contigs_tpm_norm_log_trans.tsv', sep = '\t', row.names = 1, check.names = FALSE)
...
write.table(diversity_data, '../diversity_analysis/diversity_data_table.tsv', sep = '\t', row.names = FALSE)
```
...
dend
# Open a PNG device
plot(rotate(dend, 1), main = "Cladogram of Bray-Curtis Distances", horiz = TRUE)
#tiff("cladogram_plot.tiff", width = 800, height = 600, res = 100)
